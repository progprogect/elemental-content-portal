...
import { generateJSON } from '@elemental-content/shared-ai-lib';
...
`;
    ...
    prompt += `Generate a JSON scenario with the following EXACT structure:
{
  "timeline": [
    {
      "id": "scene_intro",
...
IMPORTANT: Return a valid JSON object matching this structure exactly.`;

    // Generate scenario using OpenAI with JSON mode for guaranteed valid JSON
